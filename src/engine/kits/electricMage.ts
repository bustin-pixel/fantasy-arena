...
// decaying per jump. Deterministic: ties broken by uid. Exported for the
// Archmage's Grand Grimoire, which can roll the same bolt.
export function castChainLightning(ctx: KitCtx): boolean {
...
export const electricMageKit: UnitKit = {
  ...
  fireAbility: castChainLightning,
};
